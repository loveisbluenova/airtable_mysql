...
@section('template_title') Edit Project Page 
@endsection 
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                @endif
                {{ Form::open(array('route' => 'pros.store')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                     <!--   <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Title" name="title" type="text" id="title" value="{{$pro->title}}">
                        </div>

                        <div class="form-group">
                            <label for="body">Content</label>
                            <textarea class="form-control" placeholder="Content" id="summernote" name="body" cols="50" rows="10" style="display: none;">{!! $pro->body !!}</textarea>
                        ...
                        {{Form::close()}}
                        <script>
                            var content = <?php print_r(json_encode($pro->body)) ?>;
