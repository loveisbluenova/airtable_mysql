...
class ProsController extends Controller
{
    ...
    public function index()
    {
        ...
        if($userRole)
        {
            ...
            $access = 'Administrator';
             ...
             return view('admin.pages.edit-pro', [
            'users'             => $users,
    ...
    public function store()
    {
        ...
        $input = Input::all();
        $validation = Validator::make($input, Pro::$rules);
        ...
        {   
            ...
            return view('admin.pages.edit-pro', [
                ...
                'success'           => 'true', 
                'errors'            => '', 
                'message'           => 'Post created successfully.',], compact('pro'));
        }
        ...
        return view('admin.pages.edit-pro', [
                ...
                'success' => 'false', 
                'errors' => $validation, 
                'message' => 'All fields are required.',], compact('pro'));
    }
